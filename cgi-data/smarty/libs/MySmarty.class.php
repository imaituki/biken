...
class MySmarty extends Smarty {
	...
	function MySmarty( $type ) {
		...
		// リニューアル
		$this->assign( "_RENEWAL"       , _RENEWAL        );

		// オプション配列
		$this->assign( "OptionInfoCategory", $OptionInfoCategory );
		$this->assign( "OptionBlogCategory", $OptionBlogCategory );
	...
	function front() {
		...
		// インスタグラム
		$this->assign( "Instgram" , $Instgram  );

		// 変数 - インクルードパス
		$this->assign( "template_meta"        , _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/meta.tpl"         );
		$this->assign( "template_header"      , _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/header.tpl"       );
		$this->assign( "template_footer"      , _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/footer.tpl"       );
		$this->assign( "template_contact_area", _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/contact_area.tpl" );
		$this->assign( "template_monitor", _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/monitor.tpl" );
		$this->assign( "template_campaign", _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/campaign.tpl" );
		$this->assign( "template_javascript"  , _DOCUMENT_ROOT._RENEWAL. $_FRONT["include"]. "/javascript.tpl"   );
