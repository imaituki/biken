...
document.write('<script type="text/javascript" src="../biken/common/js/jquery.matchHeight-min.js"></script>');
...
$(function () {
	...
	$('#btn_open a').on('click', function () {
		...
		if ($('#menu_cover').get(0)) {
			$(this).html('<img src="../biken/common/image/head/sp_menu.png" alt="">');
			$('#menu_cover').remove();
		} else {
			$(this).html('<img src="../biken/common/image/head/sp_menu_b.png" alt="">');
...
// slick
document.write('<script type="text/javascript" src="../biken/common/js/slick/slick.min.js"></script>');
document.write('<link rel="stylesheet" href="../biken/common/js/slick/slick.css" type="text/css">');
